...
class CUB200DataProvider(DataProvider):
    DEFAULT_PATH = '/data/shaozl/WS-DAN-proxyless.PyTorch/CUB_200_2011'
    ...
    def __init__(self, save_path=None, train_batch_size=256, test_batch_size=512, valid_size=None, n_worker=32,
        ...
        #IN CUB200 Data is few, No Val_data
    ...
    def train_dataset(self, _transforms):
        dataset = BirdDataset('train',self.train_path, _transforms)
        return dataset

    def test_dataset(self, _transforms):
        dataset = BirdDataset('test', self.valid_path, _transforms)
        return dataset
...
class BirdDataset(Dataset):
    ...
    def __init__(self, phase='train',DATAPATH=None,transform=None):
        ...
        if self.DATAPATH==None or self.transform==None:
        ...
        for id in self.image_id:
            samples.append((self.image_path[id],id))
    ...
    def __getitem__(self, item):
        ...
        # image
        image = Image.open(os.path.join(self.DATAPATH, 'images', self.image_path[image_id])).convert('RGB')  # (C, H, W)
